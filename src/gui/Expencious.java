 ...
 * @author amirt
 */
public class Expencious extends javax.swing.JFrame {

    /**
     * Creates new form Expencious
     */
    public Expencious() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Expencious2.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Spending_Tracker c = new Spending_Tracker();
        c.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Expencious.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
